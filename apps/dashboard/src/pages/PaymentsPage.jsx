...
export default function PaymentsPage() {
  return (
    <div className="space-y-6">
      <div>
        <div className="text-2xl font-black tracking-tight text-safe-ink">Payments</div>
        <div className="mt-1 text-sm font-semibold text-slate-500">Transactions, settlements, partner earnings, cashouts.</div>
      </div>
      <div className="rounded-2xl border border-slate-200 bg-white p-5 shadow-[0_10px_30px_rgba(2,6,23,0.04)]">
        <div className="text-sm font-black text-safe-ink">Recent Transactions</div>
